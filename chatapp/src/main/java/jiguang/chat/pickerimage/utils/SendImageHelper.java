...
public class SendImageHelper {
    ...
    public static void sendImageAfterSelfImagePicker(Context context, ArrayList<ImageItem> items, final Callback callback) {
...
//        }
    ...
    public static class SendImageTask extends AsyncTask<Void, Void, File> {
        ...
        public SendImageTask(Context context, boolean isOrig,ImageItem photoInfo,
                             Callback callback) {
