...
public final class FileUtil {
    ...
    /**
     * 保存String字符串到sd卡nmms目录
     */
    public static String saveStringToFile(String filePath, String content) {
        try {
    ...
    /**
     * 将数据一条条解析成json，一行行写入文件
     *
     * @param filePath 文件地址
     * @param dataList 数据
     */
    public static boolean saveFileByLine(String filePath, List dataList) {
        if (dataList == null) {
            return false;
        }
        ...
        try {
            ...
            while (iterator.hasNext()) {
                bufferedWriter.write(JsonParseUtil.objToJson(iterator.next()));
