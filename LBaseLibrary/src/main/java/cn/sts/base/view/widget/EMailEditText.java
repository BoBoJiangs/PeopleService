...
public class EMailEditText extends AppCompatMultiAutoCompleteTextView implements
    ...
    private void init() {
        ...
        mClearDrawable.setLevel(1);//draw()方法有判断getLevel() != 0才绘制
        mClearDrawable.setBounds(0, 0, mClearDrawable.getMinimumWidth(), mClearDrawable.getMinimumHeight());//非常重要，必须设置，否则图片不会显示
