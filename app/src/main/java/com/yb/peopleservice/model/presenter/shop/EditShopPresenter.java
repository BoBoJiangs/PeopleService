 ...
 * 修改描述:
 */
public class EditShopPresenter extends AbstractPresenter<EditShopPresenter.IEditCallback> {

    public EditShopPresenter(Context context, IEditCallback viewCallBack) {
    ...
    public void editShop(ShopInfo shopInfo) {
        BaseRequestFunc<ShopRequest> requestFunc = new BaseRequestFunc<ShopRequest>(context, new IRequestListener<ShopInfo>() {
            ...
            public Observable getObservable(ShopRequest iRequestServer) {
                //店铺
                return iRequestServer.editShopInfo(shopInfo);
