package com.yb.peopleservice.view.fragment.chat;
...
import com.yb.peopleservice.model.bean.chat.Event;
import com.yb.peopleservice.model.presenter.chat.ConversationListController;
    ...
    public void onEvent(MessageEvent event) {
        ...
        if (msg.getTargetType() == ConversationType.group) {
            ...
            if (conv != null && mConvListController != null) {
                if (msg.isAtMe()) {
                    AppConstant.isAtMe.put(groupId, true);
                    mConvListController.getAdapter().putAtConv(conv, msg.getId());
                }
                if (msg.isAtAll()) {
                    AppConstant.isAtall.put(groupId, true);
...
//        if (AppConstant.delConversation != null) {
