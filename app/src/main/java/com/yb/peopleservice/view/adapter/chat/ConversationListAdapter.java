package com.yb.peopleservice.view.adapter.chat;
...
import com.yb.peopleservice.utils.ThreadUtil;
import com.yb.peopleservice.utils.chat.SharePreferenceManager;
import com.yb.peopleservice.utils.chat.SortConvList;
import com.yb.peopleservice.utils.chat.SortTopConvList;
import com.yb.peopleservice.utils.chat.SwipeLayoutConv;
import com.yb.peopleservice.utils.chat.TimeFormat;
import com.yb.peopleservice.utils.chat.ViewHolder;
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (TextUtils.isEmpty(draft)) {
            ...
            if (lastMsg != null) {
                ...
                if (mAtAll.get(position) && AppConstant.isAtall.get(gid) != null && AppConstant.isAtall.get(gid)) {
                ...
                } else if (mArray.get(position) && AppConstant.isAtMe.get(gid) != null && AppConstant.isAtMe.get(gid)) {
                    //有人@我 文字提示
                    ...
                    if (lastMsg.getTargetType() == ConversationType.group && !contentStr.equals("[群成员变动]")) {
                        ...
                        if (AppConstant.isAtall.get(gid) != null && AppConstant.isAtall.get(gid)) {
                            content.setText("[@所有人] " + fromName + ": " + contentStr);
                        } else if (AppConstant.isAtMe.get(gid) != null && AppConstant.isAtMe.get(gid)) {
                        ...
                        if (AppConstant.isAtall.get(gid) != null && AppConstant.isAtall.get(gid)) {
                            ...
                            if (lastMsg.getUnreceiptCnt() == 0) {
                                ...
                                if (lastMsg.getTargetType().equals(ConversationType.single) &&
                                    ...
                                    SpannableStringBuilder builder = new SpannableStringBuilder(contentStr);
                                    builder.setSpan(new ForegroundColorSpan(mContext.getResources().getColor(R.color.base_text_color)),
